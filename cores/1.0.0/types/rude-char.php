...
class char
{
	public static function nth($string, $n)
	{
	...
	{
		return mb_substr($string, $count, strings::length($string) - $count);
	}
	...
	public static function pop_first(&$string, $count = 1)
	{
		$char = static::first($string, $count);

		$string = static::remove_first($string, $count);

		return $char;
	}

	public static function pop_last(&$string, $count = 1)
	{
		$char = static::last($string, $count);

		$string = static::remove_last($string, $count);
	 ...
	 * @return int
	 */
	public static function count_unique($string)
	{
	...
	{
		return strings::is_utf8(char::first($char));
	}

	public static function to_hex($char)
	{
		return bin2hex($char);
	}
}