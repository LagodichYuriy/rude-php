...
//	}
	...
	public static function scheme($url) { return static::parse($url)['scheme']; }
	public static function host  ($url) { return static::parse($url)['host'];   }
	public static function path  ($url) { return static::parse($url)['path'];   }
	public static function query ($url) { return static::parse($url)['query'];  }
	...
	public static function param($url, $key, $val)
	{
