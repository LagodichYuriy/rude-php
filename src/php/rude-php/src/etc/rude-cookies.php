...
class cookies
{
	...
	public static function set($name, $value = 1, $expire = RUDE_TIME_MONTH, $path = '/', $domain = null, $secure = null, $httponly = null)
	{
		$_COOKIE[$name] = $value;
	...
	public static function delete($name = null, $path = '/')
	{
		...
		return setcookie($name, '', time() - RUDE_TIME_YEAR, $path);
	}
