...
class %PHP_CLASS_NAME%
{
	...
	public static function is_exists($%PHP_PRIMARY_KEY%)
	{
	...
	%FOR_EACH_FIELD%
	public static function is_exists_%PHP_FIELD_LOWERCASE%%ALIGN%($%PHP_FIELD_LOWERCASE%) %ALIGN%{ return static::get_by_%PHP_FIELD_LOWERCASE%%ALIGN%($%PHP_FIELD_LOWERCASE%,%ALIGN% true) == true; }
	%FOR_EACH_FIELD%
}