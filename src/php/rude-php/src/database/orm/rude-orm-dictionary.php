...
class orm_dictionary
{
	...
	private $columns = [];
	private $columns_except_primary = [];
	...
	public function set_columns_except_primary($columns) { $this->columns_except_primary = $columns; }
	...
	public function replace($template)
	{
		...
		$template = static::replace_loops($template, $this->columns_except_primary, '%FOR_EACH_FIELD_EXCEPT_PRIMARY%');
